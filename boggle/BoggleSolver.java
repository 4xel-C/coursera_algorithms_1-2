...
public class BoggleSolver {
    ...
    public Iterable<String> getAllValidWords(BoggleBoard board) {
        ...
        // Test all letters of the board and progress through neighbors to find all possible words.
    ...
    /**
     * Helper method to recursively find words in the boggleboard starting from cell row, col.
     ...
     */
    private void collect(BoggleBoard board, int row, int col, SET<String> validWords, String prefix , boolean[][] visited) {
        ...
        // base case: if the current 'newPrefix' is not the prefix of any words in the dictionary, return null.
        ...
        if (newPrefix.length() > 2 && dictionarySet.contains(newPrefix)) validWords.add(newPrefix);
        ...
        // backtrack after we explore all the possible path to not block other path eovlution.
